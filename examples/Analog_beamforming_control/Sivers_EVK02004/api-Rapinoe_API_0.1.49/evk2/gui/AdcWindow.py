...
import AdcView
import actions.adc_actions as adc_actions
...
class AdcWindow():
    ...
    def __init__(self, parent, main_view, dev, *args, **kwargs):
        ...
        self._img0 = tk.PhotoImage(file="images/add_view.png")
        self._img1 = tk.PhotoImage(file="images/remove_view.png")
        ...
        self.aa = adc_actions.AdcActions(self.main_view.gui_data)
    ...
    def add_adc_view(self):
        ...
        self.adc_view.append(AdcView.AdcView(self.adcRow[row], self.main_view, self.dev))
