...
class TxRxRamRegView():
    def __init__(self, parent, gui_handler, dev, txrx_ram, *args, **kwargs):
        ...
        self.regfield_v = RegFieldView.RegFieldView(regViewRow, None, self.host, self.dev, self.txrx_ram+'_v', button_text='Write')
        self.regfield_v.row = 0
        self.regfield_h = RegFieldView.RegFieldView(regViewRow, None, self.host, self.dev, self.txrx_ram+'_h', button_text='Write')
