...
class DemoRxView():
    ...
    def _rx_add_rx_gain_adjust_frame(self):
        ...
        self.rx_ram_v_regfield = RegFieldView.RegFieldView(row_frame[0], self._rx_ram_v_value_changed_externally, self.gui_data, self.dev, 'rx_ram_v', wr_button_text='Write & Sync', rd_button_text=None)
        self.rx_ram_v_regfield.row = DEMO_RX_RAM_INDEX
        self.rx_ram_h_regfield = RegFieldView.RegFieldView(row_frame[1], self._rx_ram_h_value_changed_externally, self.gui_data, self.dev, 'rx_ram_h', wr_button_text='Write & Sync', rd_button_text=None)
