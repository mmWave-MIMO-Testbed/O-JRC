...
import actions.rx_actions as rx_actions
...
class RxView():
    ...
    def __init__(self, parent, gui_data, dev, main_view, *args, **kwargs):
        ...
        self.ra = rx_actions.RxActions(self.gui_data)
    ...
    def _beam_set(self):
        ...
        if beam_index != None:
            ...
            self.ra.beam(beam_pol, beam_index)
    ...
    def _gain_set(self):
        ...
        if gain_index != None:
            ...
            self.ra.rf_gain(gain_pol, gain_index)
    ...
    def setup_set(self):
        ...
        self.ra.setup(mode, pol, latitude, ant_en_v, ant_en_h)
    ...
    def _calibrate(self):
        ...
        if pol == 'RV':
            ...
            pol = 'H'
        self.ra.dco_calibrate(pol, gain_index)
