...
class Init():
    ...
    'ADC': {
        ...
        'amux_ctrl_cfg'         : {'cmd': 'CLR', 'data': 0x300000}
    },
    'TEMP': {
    ...
    'SYNTH': {
        ...
        'vco_pll_bias_trim'          : {'cmd': 'WR',  'data': 0x54},
        'pll_ref_sel'                : {'cmd': 'WR',  'data': 0x01},
        'pll_config'                 : {'cmd': 'WR',  'data': 0x02},
        'pll_ld_config'              : {'cmd': 'WR',  'data': 0x10},
        'pll_en'                     : {'cmd': 'WR',  'data': 0xF3},
        'sm_dac'                     : {'cmd': 'WR',  'data': 0x6A},
        'sm_dac_cal'                 : {'cmd': 'WR',  'data': 0x07},
        'sm_dac_cal_ref'             : {'cmd': 'WR',  'data': 0xD7},
        'sm_vtune_cal'               : {'cmd': 'WR',  'data': 0x17},
        'sm_en'                      : {'cmd': 'SET', 'data': 0x93},
        'pll_ref_sel'                : {'cmd': 'WR',  'data': 0x01},
        'sm_clk_config'              : {'cmd': 'WR',  'data': 0x197b00C519},
        'sm_ibias_stv'               : {'cmd': 'WR',  'data': 0x20}        
    },
    'SYNTH_ADC': {
        'bist_config'                : {'cmd': 'SET', 'data': 0x01},
    ...
    'RX': {
        ...
        'com_bias_lo_trim'           : {'cmd': 'SET', 'data': 0x6606},
        'com_bias_rx_trim'           : {'cmd': 'SET', 'data': 0x606},
        'bb_rx_bias_adj'             : {'cmd': 'WR',  'data': 0x44},
    ...
    'TX': {
        ...
        'en_vcc_high_ovr'            : {'cmd': 'WR',  'data': 0b1111},
        'bf_biasref_en'              : {'cmd': 'WR',  'data': 0b0110011},
        'bf_tx_biasref_trim'         : {'cmd': 'WR',  'data': 0x363},
        'com_misc'                   : {'cmd': 'WR',  'data': 0b000010},
        'com_bias_lo_trim'           : {'cmd': 'SET', 'data': 0x6660},
        'com_bias_tx_trim'           : {'cmd': 'SET', 'data': 0x242422},
