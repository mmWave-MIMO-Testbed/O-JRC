...
class mimo_ofdm_comm_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.mimo_ofdm_jrc_socket_pdu_jrc_1 = mimo_ofdm_jrc.socket_pdu_jrc('UDP_SERVER', '', '52001', mtu_value)
        ...
        self.blocks_message_strobe_0 = blocks.message_strobe(pmt.from_long(msg_one), period_socket_pdu_jrc)
    ...
    def get_period_socket_pdu_jrc(self):
        return self.period_socket_pdu_jrc

    def set_period_socket_pdu_jrc(self, period_socket_pdu_jrc):
        self.period_socket_pdu_jrc = period_socket_pdu_jrc
        self.blocks_message_strobe_0.set_period(self.period_socket_pdu_jrc)
    ...
    def get_msg_one(self):
        return self.msg_one

    def set_msg_one(self, msg_one):
        self.msg_one = msg_one
        self.blocks_message_strobe_0.set_msg(pmt.from_long(self.msg_one))
