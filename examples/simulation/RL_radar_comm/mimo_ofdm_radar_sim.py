...
class mimo_ofdm_radar_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.target_data_file = target_data_file = os.getcwd()+"/temp/target_data.csv"
        ...
        self.mimo_ofdm_jrc_Multi_targets_simulator_0_0_0_0 = mimo_ofdm_jrc.Multi_targets_simulator_make_from_csv( '/home/haocheng/O-JRC/examples/data/target_data.csv', TX4_RXs, samp_rate, rf_freq, -40, False, False, "packet_len", False)
        self.mimo_ofdm_jrc_Multi_targets_simulator_0_0_0_0.set_min_output_buffer(64000)
        self.mimo_ofdm_jrc_Multi_targets_simulator_0_0_0 = mimo_ofdm_jrc.Multi_targets_simulator_make_from_csv( '/home/haocheng/O-JRC/examples/data/target_data.csv', TX3_RXs, samp_rate, rf_freq, -40, False, False, "packet_len", False)
        self.mimo_ofdm_jrc_Multi_targets_simulator_0_0_0.set_min_output_buffer(64000)
        self.mimo_ofdm_jrc_Multi_targets_simulator_0_0 = mimo_ofdm_jrc.Multi_targets_simulator_make_from_csv( '/home/haocheng/O-JRC/examples/data/target_data.csv', TX2_RXs, samp_rate, rf_freq, -40, False, False, "packet_len", False)
        self.mimo_ofdm_jrc_Multi_targets_simulator_0_0.set_min_output_buffer(64000)
        self.mimo_ofdm_jrc_Multi_targets_simulator_0 = mimo_ofdm_jrc.Multi_targets_simulator_make_from_csv( '/home/haocheng/O-JRC/examples/data/target_data.csv', TX1_RXs, samp_rate, rf_freq, -40, False, False, "packet_len", False)
