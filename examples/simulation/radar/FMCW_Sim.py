...
class FMCW_Sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._delay_samp_range = Range(0, 10000, 1, 17, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.26))
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, bandwidth*cmath.pi*2, amplitude)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 1/Sweeptime, amplitude, 0, 0)
        ...
        self.connect((self.blocks_vco_c_0, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.bandwidth, 30e3, firdes.WIN_HAMMING, 6.26))
