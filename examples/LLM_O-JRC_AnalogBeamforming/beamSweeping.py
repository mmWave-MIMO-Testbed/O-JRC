...
print("Radar Log Path:", radar_log_path)
print("Communication Log Path:", comm_log_path)
print("Packet Log Path:", packet_log_path)
print("Plot Log Path:", plot_log_path)
print("Radar Data File Path:", radar_data_path)
