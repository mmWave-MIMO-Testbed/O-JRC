...
class V0_SISO_OFDM_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "V0_SISO_OFDM_RX")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("V0_SISO_OFDM_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "V0_SISO_OFDM_RX")
        ...
        self.rf_frequency = rf_frequency = usrp_freq+24.6e9
        ...
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.mimo_ofdm_jrc_stream_decoder_0 = mimo_ofdm_jrc.stream_decoder(len(ofdm_config_siso.data_subcarriers), comm_log_file, save_comm_log, False)
        ...
        self.mimo_ofdm_jrc_mimo_ofdm_equalizer_0 = mimo_ofdm_jrc.mimo_ofdm_equalizer(chan_est, rf_frequency, samp_rate, fft_len, cp_len, ofdm_config_siso.data_subcarriers, ofdm_config_siso.pilot_subcarriers, ofdm_config_siso.pilot_symbols, ofdm_config_siso.l_stf_ltf_64[3], ofdm_config_siso.ltf_mapped_sc__ss_sym, N_tx, chan_est_file, comm_log_file, chan_est_data_file,chan_est_ndp_file ,False, False)
        ...
        self.mimo_ofdm_jrc_frame_sync_0 = mimo_ofdm_jrc.frame_sync(fft_len, cp_len, sync_length, ofdm_config_siso.l_ltf_fir, False)
        self.mimo_ofdm_jrc_frame_detector_0 = mimo_ofdm_jrc.frame_detector(64, 16, 0.85, 30, (len(ofdm_config_siso.l_stf_ltf_64)+N_tx)*(fft_len+cp_len), False)
        ...
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_gr_complex*1, len(ofdm_config_siso.data_subcarriers))
    ...
    def set_usrp_freq(self, usrp_freq):
        ...
        self.set_rf_frequency(self.usrp_freq+24.6e9)
...
def main(top_block_cls=V0_SISO_OFDM_RX, options=None):
