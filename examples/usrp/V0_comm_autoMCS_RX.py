...
class V0_comm_autoMCS_RX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "V0_comm_autoMCS_RX")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("V0_comm_autoMCS_RX")
        ...
        self.settings = Qt.QSettings("GNU Radio", "V0_comm_autoMCS_RX")
...
def main(top_block_cls=V0_comm_autoMCS_RX, options=None):
