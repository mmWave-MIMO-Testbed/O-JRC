...
class mimo_ofdm_jrc_TRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.phase_tx4 = phase_tx4 = 2.13
        self.phase_tx3 = phase_tx3 = 2.07
        self.phase_tx2 = phase_tx2 = -0.81
        self.phase_rx2 = phase_rx2 = -1.04
        ...
        self.amp_tx4 = amp_tx4 = 0.81
        self.amp_tx3 = amp_tx3 = 0.72
        self.amp_tx2 = amp_tx2 = 0.71
        self.amp_rx2 = amp_rx2 = 1.1
        ...
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._phase_tx4_range = Range(-2*cmath.pi, 2*cmath.pi, 0.01, 2.13, 200)
        ...
        for c in range(6, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._phase_tx3_range = Range(-2*cmath.pi, 2*cmath.pi, 0.01, 2.07, 200)
        ...
        for c in range(4, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._phase_tx2_range = Range(-2*cmath.pi, 2*cmath.pi, 0.01, -0.81, 200)
        ...
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._phase_rx2_range = Range(-2*cmath.pi, 2*cmath.pi, 0.01, -1.04, 200)
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._amp_tx4_range = Range(0, 10, 0.01, 0.81, 200)
        ...
        for c in range(6, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._amp_tx3_range = Range(0, 10, 0.01, 0.72, 200)
        ...
        for c in range(4, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._amp_tx2_range = Range(0, 10, 0.01, 0.71, 200)
        ...
        for c in range(2, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._amp_rx2_range = Range(0, 10, 0.01, 1.1, 200)
        ...
        self.mimo_ofdm_jrc_range_angle_estimator_0 = mimo_ofdm_jrc.range_angle_estimator(N_tx*N_rx*interp_factor_angle, np.linspace(0, 3e8*fft_len/(2*samp_rate), fft_len*interp_factor), np.arcsin( 2/(N_tx*N_rx*interp_factor_angle)*(np.arange(0, N_tx*N_rx*interp_factor_angle)-np.floor(N_tx*N_rx*interp_factor_angle/2)+0.5) )*180/cmath.pi, R_res*2, angle_res*2, 15, 200, radar_log_file, signal_strength_log_file, save_radar_log, "packet_len", False)
