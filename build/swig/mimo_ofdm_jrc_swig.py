...
class NDP_Generator(object):
    ...
    Return a shared_ptr to a new instance of mimo_ofdm_jrc::NDP_Generator.

    To avoid accidental use of raw pointers, mimo_ofdm_jrc::NDP_Generator's constructor is in a private implementation class. mimo_ofdm_jrc::NDP_Generator::make is the public interface for creating new instances.
    """
...
class NDP_Gen_UDP(object):
    r"""
    <+description of block+>

    Constructor Specific Documentation:

    Return a shared_ptr to a new instance of mimo_ofdm_jrc::NDP_Gen_UDP.

    To avoid accidental use of raw pointers, mimo_ofdm_jrc::NDP_Gen_UDP's constructor is in a private implementation class. mimo_ofdm_jrc::NDP_Gen_UDP::make is the public interface for creating new instances.
    ...
    @staticmethod
    def make(host: "std::string const &", port: "int", interval: "int") -> "gr::mimo_ofdm_jrc::NDP_Gen_UDP::sptr":
        r"""
        make(std::string const & host, int port, int interval) -> NDP_Gen_UDP_sptr
        <+description of block+>
        ...
        Args:
            ...
            interval : 
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_make(host, port, interval)
    __swig_destroy__ = _mimo_ofdm_jrc_swig.delete_NDP_Gen_UDP

# Register NDP_Gen_UDP in _mimo_ofdm_jrc_swig:
_mimo_ofdm_jrc_swig.NDP_Gen_UDP_swigregister(NDP_Gen_UDP)

def NDP_Gen_UDP_make(host: "std::string const &", port: "int", interval: "int") -> "gr::mimo_ofdm_jrc::NDP_Gen_UDP::sptr":
    r"""
    NDP_Gen_UDP_make(std::string const & host, int port, int interval) -> NDP_Gen_UDP_sptr
    <+description of block+>
...
class NDP_Gen_UDP_sptr(object):
    r"""Proxy of C++ boost::shared_ptr< gr::mimo_ofdm_jrc::NDP_Gen_UDP > class."""
    ...
    def __init__(self, *args):
        r"""
        __init__(NDP_Gen_UDP_sptr self) -> NDP_Gen_UDP_sptr
        __init__(NDP_Gen_UDP_sptr self, NDP_Gen_UDP p) -> NDP_Gen_UDP_sptr
        """
        _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_swiginit(self, _mimo_ofdm_jrc_swig.new_NDP_Gen_UDP_sptr(*args))

    def __deref__(self) -> "gr::mimo_ofdm_jrc::NDP_Gen_UDP *":
        r"""__deref__(NDP_Gen_UDP_sptr self) -> NDP_Gen_UDP"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr___deref__(self)
    __swig_destroy__ = _mimo_ofdm_jrc_swig.delete_NDP_Gen_UDP_sptr

    def make(self, host: "std::string const &", port: "int", interval: "int") -> "gr::mimo_ofdm_jrc::NDP_Gen_UDP::sptr":
        r"""
        make(NDP_Gen_UDP_sptr self, std::string const & host, int port, int interval) -> NDP_Gen_UDP_sptr
        <+description of block+>
        ...
        Args:
            ...
            interval : 
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_make(self, host, port, interval)

    def history(self) -> "unsigned int":
        r"""history(NDP_Gen_UDP_sptr self) -> unsigned int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_history(self)

    def declare_sample_delay(self, *args) -> "void":
        r"""
        declare_sample_delay(NDP_Gen_UDP_sptr self, int which, int delay)
        declare_sample_delay(NDP_Gen_UDP_sptr self, unsigned int delay)
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_declare_sample_delay(self, *args)

    def sample_delay(self, which: "int") -> "unsigned int":
        r"""sample_delay(NDP_Gen_UDP_sptr self, int which) -> unsigned int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_sample_delay(self, which)

    def set_output_multiple(self, multiple: "int") -> "void":
        r"""set_output_multiple(NDP_Gen_UDP_sptr self, int multiple)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_output_multiple(self, multiple)

    def output_multiple(self) -> "int":
        r"""output_multiple(NDP_Gen_UDP_sptr self) -> int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_output_multiple(self)

    def relative_rate(self) -> "double":
        r"""relative_rate(NDP_Gen_UDP_sptr self) -> double"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_relative_rate(self)

    def relative_rate_i(self) -> "uint64_t":
        r"""relative_rate_i(NDP_Gen_UDP_sptr self) -> uint64_t"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_relative_rate_i(self)

    def relative_rate_d(self) -> "uint64_t":
        r"""relative_rate_d(NDP_Gen_UDP_sptr self) -> uint64_t"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_relative_rate_d(self)

    def start(self) -> "bool":
        r"""start(NDP_Gen_UDP_sptr self) -> bool"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_start(self)

    def stop(self) -> "bool":
        r"""stop(NDP_Gen_UDP_sptr self) -> bool"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_stop(self)

    def nitems_read(self, which_input: "unsigned int") -> "uint64_t":
        r"""nitems_read(NDP_Gen_UDP_sptr self, unsigned int which_input) -> uint64_t"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_nitems_read(self, which_input)

    def nitems_written(self, which_output: "unsigned int") -> "uint64_t":
        r"""nitems_written(NDP_Gen_UDP_sptr self, unsigned int which_output) -> uint64_t"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_nitems_written(self, which_output)

    def set_log_level(self, level: "std::string") -> "void":
        r"""set_log_level(NDP_Gen_UDP_sptr self, std::string level)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_log_level(self, level)

    def log_level(self) -> "std::string":
        r"""log_level(NDP_Gen_UDP_sptr self) -> std::string"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_log_level(self)

    def max_noutput_items(self) -> "int":
        r"""max_noutput_items(NDP_Gen_UDP_sptr self) -> int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_max_noutput_items(self)

    def set_max_noutput_items(self, m: "int") -> "void":
        r"""set_max_noutput_items(NDP_Gen_UDP_sptr self, int m)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_max_noutput_items(self, m)

    def unset_max_noutput_items(self) -> "void":
        r"""unset_max_noutput_items(NDP_Gen_UDP_sptr self)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_unset_max_noutput_items(self)

    def is_set_max_noutput_items(self) -> "bool":
        r"""is_set_max_noutput_items(NDP_Gen_UDP_sptr self) -> bool"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_is_set_max_noutput_items(self)

    def set_min_noutput_items(self, m: "int") -> "void":
        r"""set_min_noutput_items(NDP_Gen_UDP_sptr self, int m)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_min_noutput_items(self, m)

    def min_noutput_items(self) -> "int":
        r"""min_noutput_items(NDP_Gen_UDP_sptr self) -> int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_min_noutput_items(self)

    def max_output_buffer(self, i: "int") -> "long":
        r"""max_output_buffer(NDP_Gen_UDP_sptr self, int i) -> long"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_max_output_buffer(self, i)

    def set_max_output_buffer(self, *args) -> "void":
        r"""
        set_max_output_buffer(NDP_Gen_UDP_sptr self, long max_output_buffer)
        set_max_output_buffer(NDP_Gen_UDP_sptr self, int port, long max_output_buffer)
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_max_output_buffer(self, *args)

    def min_output_buffer(self, i: "int") -> "long":
        r"""min_output_buffer(NDP_Gen_UDP_sptr self, int i) -> long"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_min_output_buffer(self, i)

    def set_min_output_buffer(self, *args) -> "void":
        r"""
        set_min_output_buffer(NDP_Gen_UDP_sptr self, long min_output_buffer)
        set_min_output_buffer(NDP_Gen_UDP_sptr self, int port, long min_output_buffer)
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_min_output_buffer(self, *args)

    def pc_noutput_items(self) -> "float":
        r"""pc_noutput_items(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_noutput_items(self)

    def pc_noutput_items_avg(self) -> "float":
        r"""pc_noutput_items_avg(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_noutput_items_avg(self)

    def pc_noutput_items_var(self) -> "float":
        r"""pc_noutput_items_var(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_noutput_items_var(self)

    def pc_nproduced(self) -> "float":
        r"""pc_nproduced(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_nproduced(self)

    def pc_nproduced_avg(self) -> "float":
        r"""pc_nproduced_avg(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_nproduced_avg(self)

    def pc_nproduced_var(self) -> "float":
        r"""pc_nproduced_var(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_nproduced_var(self)

    def pc_input_buffers_full(self, *args) -> "std::vector< float,std::allocator< float > >":
        r"""
        pc_input_buffers_full(NDP_Gen_UDP_sptr self, int which) -> float
        pc_input_buffers_full(NDP_Gen_UDP_sptr self) -> pmt_vector_float
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_input_buffers_full(self, *args)

    def pc_input_buffers_full_avg(self, *args) -> "std::vector< float,std::allocator< float > >":
        r"""
        pc_input_buffers_full_avg(NDP_Gen_UDP_sptr self, int which) -> float
        pc_input_buffers_full_avg(NDP_Gen_UDP_sptr self) -> pmt_vector_float
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_input_buffers_full_avg(self, *args)

    def pc_input_buffers_full_var(self, *args) -> "std::vector< float,std::allocator< float > >":
        r"""
        pc_input_buffers_full_var(NDP_Gen_UDP_sptr self, int which) -> float
        pc_input_buffers_full_var(NDP_Gen_UDP_sptr self) -> pmt_vector_float
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_input_buffers_full_var(self, *args)

    def pc_output_buffers_full(self, *args) -> "std::vector< float,std::allocator< float > >":
        r"""
        pc_output_buffers_full(NDP_Gen_UDP_sptr self, int which) -> float
        pc_output_buffers_full(NDP_Gen_UDP_sptr self) -> pmt_vector_float
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_output_buffers_full(self, *args)

    def pc_output_buffers_full_avg(self, *args) -> "std::vector< float,std::allocator< float > >":
        r"""
        pc_output_buffers_full_avg(NDP_Gen_UDP_sptr self, int which) -> float
        pc_output_buffers_full_avg(NDP_Gen_UDP_sptr self) -> pmt_vector_float
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_output_buffers_full_avg(self, *args)

    def pc_output_buffers_full_var(self, *args) -> "std::vector< float,std::allocator< float > >":
        r"""
        pc_output_buffers_full_var(NDP_Gen_UDP_sptr self, int which) -> float
        pc_output_buffers_full_var(NDP_Gen_UDP_sptr self) -> pmt_vector_float
        """
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_output_buffers_full_var(self, *args)

    def pc_work_time(self) -> "float":
        r"""pc_work_time(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_work_time(self)

    def pc_work_time_avg(self) -> "float":
        r"""pc_work_time_avg(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_work_time_avg(self)

    def pc_work_time_var(self) -> "float":
        r"""pc_work_time_var(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_work_time_var(self)

    def pc_work_time_total(self) -> "float":
        r"""pc_work_time_total(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_work_time_total(self)

    def pc_throughput_avg(self) -> "float":
        r"""pc_throughput_avg(NDP_Gen_UDP_sptr self) -> float"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_pc_throughput_avg(self)

    def set_processor_affinity(self, mask: "std::vector< int,std::allocator< int > > const &") -> "void":
        r"""set_processor_affinity(NDP_Gen_UDP_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_processor_affinity(self, mask)

    def unset_processor_affinity(self) -> "void":
        r"""unset_processor_affinity(NDP_Gen_UDP_sptr self)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_unset_processor_affinity(self)

    def processor_affinity(self) -> "std::vector< int,std::allocator< int > >":
        r"""processor_affinity(NDP_Gen_UDP_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_processor_affinity(self)

    def active_thread_priority(self) -> "int":
        r"""active_thread_priority(NDP_Gen_UDP_sptr self) -> int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_active_thread_priority(self)

    def thread_priority(self) -> "int":
        r"""thread_priority(NDP_Gen_UDP_sptr self) -> int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_thread_priority(self)

    def set_thread_priority(self, priority: "int") -> "int":
        r"""set_thread_priority(NDP_Gen_UDP_sptr self, int priority) -> int"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_thread_priority(self, priority)

    def name(self) -> "std::string":
        r"""name(NDP_Gen_UDP_sptr self) -> std::string"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_name(self)

    def symbol_name(self) -> "std::string":
        r"""symbol_name(NDP_Gen_UDP_sptr self) -> std::string"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_symbol_name(self)

    def input_signature(self) -> "gr::io_signature::sptr":
        r"""input_signature(NDP_Gen_UDP_sptr self) -> io_signature_sptr"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_input_signature(self)

    def output_signature(self) -> "gr::io_signature::sptr":
        r"""output_signature(NDP_Gen_UDP_sptr self) -> io_signature_sptr"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_output_signature(self)

    def unique_id(self) -> "long":
        r"""unique_id(NDP_Gen_UDP_sptr self) -> long"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_unique_id(self)

    def to_basic_block(self) -> "gr::basic_block_sptr":
        r"""to_basic_block(NDP_Gen_UDP_sptr self) -> basic_block_sptr"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_to_basic_block(self)

    def check_topology(self, ninputs: "int", noutputs: "int") -> "bool":
        r"""check_topology(NDP_Gen_UDP_sptr self, int ninputs, int noutputs) -> bool"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_check_topology(self, ninputs, noutputs)

    def alias(self) -> "std::string":
        r"""alias(NDP_Gen_UDP_sptr self) -> std::string"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_alias(self)

    def set_block_alias(self, name: "std::string") -> "void":
        r"""set_block_alias(NDP_Gen_UDP_sptr self, std::string name)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_set_block_alias(self, name)

    def _post(self, which_port: "swig_pmt_ptr", msg: "swig_pmt_ptr") -> "void":
        r"""_post(NDP_Gen_UDP_sptr self, swig_pmt_ptr which_port, swig_pmt_ptr msg)"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr__post(self, which_port, msg)

    def message_ports_in(self) -> "pmt::pmt_t":
        r"""message_ports_in(NDP_Gen_UDP_sptr self) -> swig_pmt_ptr"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_message_ports_in(self)

    def message_ports_out(self) -> "pmt::pmt_t":
        r"""message_ports_out(NDP_Gen_UDP_sptr self) -> swig_pmt_ptr"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_message_ports_out(self)

    def message_subscribers(self, which_port: "swig_pmt_ptr") -> "pmt::pmt_t":
        r"""message_subscribers(NDP_Gen_UDP_sptr self, swig_pmt_ptr which_port) -> swig_pmt_ptr"""
        return _mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_message_subscribers(self, which_port)

# Register NDP_Gen_UDP_sptr in _mimo_ofdm_jrc_swig:
_mimo_ofdm_jrc_swig.NDP_Gen_UDP_sptr_swigregister(NDP_Gen_UDP_sptr)


NDP_Gen_UDP_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
NDP_Gen_UDP = NDP_Gen_UDP.make;
