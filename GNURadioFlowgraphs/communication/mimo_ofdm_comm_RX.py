...
class mimo_ofdm_comm_RX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.comm_log_file = comm_log_file = "/home/hostpc-usrp/temp/comm_log.csv"
        ...
        self._save_comm_log_labels = ['False', 'True']
        ...
        self.qtgui_time_sink_x_0_2.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.8, 300, 0, '')
        ...
        self.mimo_ofdm_jrc_moving_avg_1 = mimo_ofdm_jrc.moving_avg(corr_window_size, 1, 20000, False)
        ...
        self.mimo_ofdm_jrc_mimo_ofdm_equalizer_0 = mimo_ofdm_jrc.mimo_ofdm_equalizer(chan_est, rf_frequency, samp_rate, fft_len, cp_len, ofdm_config.data_subcarriers, ofdm_config.pilot_subcarriers, ofdm_config.pilot_symbols, ofdm_config.l_stf_ltf_64[3], ofdm_config.ltf_mapped_sc__ss_sym, N_tx, chan_est_file, comm_log_file, False, True)
        self.mimo_ofdm_jrc_gui_time_plot_1 = mimo_ofdm_jrc.gui_time_plot(250, "SNR", "SNR [dB]", [0, 40], 10, "Signal-to-Noise Ratio")
        self.mimo_ofdm_jrc_gui_time_plot_0 = mimo_ofdm_jrc.gui_time_plot(250, "PER", "PER [%]", [0, 102], 10, "Packet Error Rate")
        self.mimo_ofdm_jrc_frame_sync_0 = mimo_ofdm_jrc.frame_sync(fft_len, cp_len, sync_length, ofdm_config.l_ltf_fir, False)
        self.mimo_ofdm_jrc_frame_sync_0.set_processor_affinity([4])
        self.mimo_ofdm_jrc_frame_detector_0 = mimo_ofdm_jrc.frame_detector(fft_len, cp_len, 0.85, 30, (len(ofdm_config.l_stf_ltf_64)+N_tx)*(fft_len+cp_len), False)
    ...
    def set_corr_window_size(self, corr_window_size):
        ...
        self.blocks_moving_average_xx_1_0.set_length_and_scale(int(self.corr_window_size)+int(self.fft_len/4), 1/1.5)
        self.mimo_ofdm_jrc_moving_avg_1.set_length_and_scale(self.corr_window_size, 1)
