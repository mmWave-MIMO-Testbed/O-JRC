...
class mimo_ofdm_comm_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Mimo Ofdm Comm Sim")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Mimo Ofdm Comm Sim")
        ...
        self.comm_log_file = comm_log_file = "/home/workstation/temp_mimo/comm_stats.csv"
        self.chan_est_file = chan_est_file = "/home/workstation/temp_mimo/chan_est.csv"
        ...
        self._theta_range = Range(-90, 90, 1, 0, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.mimo_ofdm_jrc_zero_pad_0_0_0_0 = mimo_ofdm_jrc.zero_pad(False, 2*(fft_len+cp_len)+10, 6*(fft_len+cp_len)+10)
        self.mimo_ofdm_jrc_zero_pad_0_0_0 = mimo_ofdm_jrc.zero_pad(False, 2*(fft_len+cp_len)+10, 6*(fft_len+cp_len)+10)
        self.mimo_ofdm_jrc_zero_pad_0_0 = mimo_ofdm_jrc.zero_pad(False, 2*(fft_len+cp_len)+10, 6*(fft_len+cp_len)+10)
        self.mimo_ofdm_jrc_zero_pad_0 = mimo_ofdm_jrc.zero_pad(False, 2*(fft_len+cp_len)+10, 6*(fft_len+cp_len)+10)
        ...
        self.mimo_ofdm_jrc_mimo_precoder_0 = mimo_ofdm_jrc.mimo_precoder(fft_len, N_tx, 1, ofdm_config.data_subcarriers, ofdm_config.pilot_subcarriers, ofdm_config.pilot_symbols, ofdm_config.l_stf_ltf_64, ofdm_config.ltf_mapped_sc__ss_sym, "", False, radar_log_file, radar_aided, False, use_radar_streams, "packet_len",  False)
        ...
        self.mimo_ofdm_jrc_gui_time_plot_1 = mimo_ofdm_jrc.gui_time_plot(250, "per", "PER [%]", [0,120], 10, "Packet Error Rate")
        ...
        self.connect((self.mimo_ofdm_jrc_stream_decoder_0, 0), (self.qtgui_histogram_sink_x_0, 0))
        self.connect((self.mimo_ofdm_jrc_stream_decoder_0, 0), (self.qtgui_time_sink_x_1, 0))
