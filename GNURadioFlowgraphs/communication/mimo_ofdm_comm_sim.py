...
class mimo_ofdm_comm_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_read_file = radar_read_file = "/home/haocheng/temp/radar_read.csv"
        ...
        self.comm_log_file = comm_log_file = "/home/haocheng/temp/comm_stats.csv"
        self.chan_est_file = chan_est_file = "/home/haocheng/temp/chan_est.csv"
        ...
        self.mimo_ofdm_jrc_gui_time_plot_1_0_0 = mimo_ofdm_jrc.gui_time_plot(150, "average snr", "average SNR[dB]", [-10,40], 10, "average SNR sync with PER")
        self.mimo_ofdm_jrc_gui_time_plot_1_0 = mimo_ofdm_jrc.gui_time_plot(150, "throughput", "Throughput [KByte/s]", [0,30], 10, "Received Data Throughput")
        self.mimo_ofdm_jrc_gui_time_plot_1 = mimo_ofdm_jrc.gui_time_plot(150, "per", "PER [%]", [0,102], 10, "Packet Error Rate")
        self.mimo_ofdm_jrc_gui_time_plot_0 = mimo_ofdm_jrc.gui_time_plot(150, "snr", "SNR [dB]", [-10,40], 10, "Signal-to-Noise Ratio")
        ...
        self.msg_connect((self.mimo_ofdm_jrc_stream_decoder_0, 'stats'), (self.mimo_ofdm_jrc_gui_time_plot_1_0_0, 'stats'))
